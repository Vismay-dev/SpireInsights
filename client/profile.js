...
const Profile = () => {
  ...
  useEffect(() => {
    setHours(
      Math.abs(new Date() - new Date(userInfo.createdAt)) /
        (36 * Math.pow(10, 5))
    );
    setDays(
      Math.abs(new Date() - new Date(userInfo.createdAt)) /
    ...
    axios
      .post(
        process.env.NODE_ENV === "production"
          ? "https://spire-insights.herokuapp.com/api/user/uploadProfPic"
  ...
  const removeProfPic = (e) => {
    ...
    axios
      .post(
        process.env.NODE_ENV === "production"
          ? "https://spire-insights.herokuapp.com/api/user/updateUser"
  ...
  return (
    <div class="xl:pt-28  pt-28 -mb-16 pb-7 relative block  overflow-hidden bg-gradient-to-r from-gray-200 to-blue-200">
      ...
      <h1 class="relative mx-auto -mt-[75px] px-4 text-center md:text-[53px] text-[49px] font-semibold">
            ...
            <div className="px-7">
                ...
                <div className="lg:w-4/12 w-[270px] xl:w-3/12 xl:ml-10   px-4  lg:order-2 order-1 flex justify-center">
                  <div className="relative scale-90 block  object-contain rounded-full  p-3">
                    ...
                    {picLoading ? (
                      ...
                      <img
                        class={`rounded-full -mt-16 -mb-2  md:w-48 w-40 h-40 md:h-48 object-cover bg-white  shadow-lg block ${
                    ...
                    {currentUser.user.profilePic ? (
                      <i
                        ...
                        className={`fas hover:cursor-pointer hover:text-orange-700  fa-trash font-semibold text-2xl absolute right-0 ${
                          picLoading
                            ? "bottom-5 hidden -right-2"
                            : "lg:bottom-12 bottom-1 -right-1 "
                        } text-red-600`}
                      >
                        <Tooltip
                          show={showToolTip2}
                    ...
                    <i
                      ...
                      className={`fas hover:cursor-pointer hover:text-indigo-700 text-2xl fa-camera font-semibold  ${
                        currentUser.user.profilePic
                          ? "lg:bottom-5 -bottom-7 lg:right-9 right-7 absolute"
                          : "lg:right-1 -right-1 absolute lg:bottom-9 bottom-0"
                      } ${picLoading ? "mt-4 -mr-8" : ""} text-gray-800`}
                    >
                      <Tooltip
                        position="bottom"
                        fontSize="16px"
              ...
              <div className="text-center lg:mt-0 mt-3 mb-8">
                ...
                <div class="h-[243px] relative ">
                  <h1 class="text-3xl font-bold text-center top-[104px] left-[4px] relative text-gray-500">
                    No Listings Created <span class="text-blue-700">Yet</span>
                  </h1>
                </div>
                ...
                <div class="h-[378px] relative top-[26px] md:left-1.5 ">
                  {userInfo.paid ? (
                    userInfo.subscription === "one" ? (
                      <>
                        <h1 class="text-2xl sm:mt-0 -mt-3 sm:px-0 px-8 font-bold text-center top-[60px] left-[4px] relative text-gray-500 underline">
                          Premium <span class="sm:inline hidden">-</span>{" "}
                          <span class="text-blue-700 sm:inline block sm:underline no-underline">
                        ...
                        <img
                          src={paid}
                          class="mx-auto block sm:mt-[105px] mt-[100px] pb-14 left-[8px] mb-6 relative sm:w-32 w-28"
                        ></img>
                      </>
                    ...
                    <>
                      <h1 class="text-2xl font-bold text-center top-[60px] left-[4px] relative text-gray-500 underline">
                        Free Trial -{" "}
                        <span class="text-blue-700">
                          {hours ? 48 - Math.floor(hours) : ""} hours left!
                        </span>
                      </h1>
                      ...
                      <img
                        src={free}
                        class="mx-auto block mt-[105px] pb-14 left-[8px] mb-6 relative w-44"
                      ></img>
                    </>
                  )}
