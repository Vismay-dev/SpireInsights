         ...
         <div data-aos="fade-up" data-aos-once='true' data-aos-delay = '400' class="w-full lg:w-1/3 md:w-1/2 md:px-4 px-1">
            <div
               ...
               <h2 class="font-bold text-dark mb-5  text-[42px]">
                  ...
                  / 48 <span class = 'lg:inline hidden'>hrs</span> <span class = 'lg:hidden inline'>hrs</span>
                  </span>
               </h2>
               <p
                  class="
         ...
         <div data-aos="fade-up" data-aos-once='true' data-aos-delay = '200' class="w-full lg:w-1/3 md:w-1/2 md:px-4 px-1">
            <div
               ...
               <div class="mb-7">
                  ...
                  <p class="text-base text-body-color leading-loose mb-1">
                  Real-time Insights <span class = 'inline'>on Marketplace trends.</span>
                  </p>
                  <p class="text-base text-body-color leading-loose mb-1">
         ...
         <div data-aos="fade-up" data-aos-once='true' class="w-full lg:w-1/3 md:w-1/2 md:px-4 px-1">
            <div
               ...
               <p
                  ...
                  "
                  >
                  <span class = 'font-bold text-indigo-600 mr-[2px] text-2xl'>20% Discount.</span> 
               </p>
