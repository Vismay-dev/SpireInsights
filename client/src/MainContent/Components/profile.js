...
const Profile = () => {
    ...
    return (
        ...
        <div class="xl:pt-28  pt-28 -mb-16 pb-7 relative block  overflow-hidden bg-gradient-to-r from-gray-200 to-blue-200">
            ...
            <h1 class = 'relative mx-auto -mt-[75px] px-4 text-center text-[53px] font-semibold'><span class = 'text-blue-600'>Your</span> Profile</h1>
            <div class="relative -mt-[66px] -mb-60  max-h-80">
      <svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <section  className="relative py-16 bg-blueGray-200">
          <div  className="container mx-auto px-4">
            <div className="relative flex flex-col  min-w-0 pb-4  break-words bg-gradient-to-br from-white to-gray-100 w-full lg:-mb-40 md:-mb-16  md:mt-5 lg:mt-4 sm:-mb-8 sm:mt-7 -mb-2 shadow-xl rounded-xl">
              <div  className="px-6">
                <div data-aos={"zoom-in-up"} data-aos-once='true'  className="flex flex-wrap justify-center">
                  <div   className="lg:w-4/12 w-[270px] xl:w-3/12 xl:ml-10   px-4  lg:order-2 order-1 flex justify-center">
                    ...
                    <input ref={inputRef} onChange = {profPicUpload} type="file" name="article_picture" style={{'display': 'none'}}/>
                    {
                      ...
                      <img class={`rounded-full -mt-16 -mb-2  w-48 h-48 object-contain bg-white  shadow-lg block ${currentUser.user.profilePic?'':'p-2'} relative`}
                 ...
                 removeProfPic()}} className={`fas hover:cursor-pointer hover:text-orange-700  fa-trash font-semibold text-2xl absolute right-0 ${picLoading?'bottom-5 -right-2':'bottom-12 -right-1 '} text-red-600`}>
...
:''}
        ...
        onMouseLeave={() => setShowToolTip(false)}
          onClick={()=>{setShowToolTip(false); inputRef.current.click()}}  className={`fas hover:cursor-pointer hover:text-indigo-700 text-2xl fa-camera font-semibold  ${currentUser.user.profilePic?'bottom-0.5 right-6 absolute':'right-0 absolute bottom-4.5'} ${picLoading?'mt-3':''} text-gray-800`}>
