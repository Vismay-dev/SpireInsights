  ...
  useEffect(() => {
    if (
      ...
      for (let i = 0; i < props.analysis.searchVolumeData.length; i++) {
        if (props.analysis.searchVolumeData[i].searchResults !== h) {
          curr +=
            props.analysis.searchVolumeData[i].searchResults / parseFloat(h);
        }
      }

      if (
        props.analysis.searchVolumeData.length === 1 &&
        props.analysis.searchVolumeData[0].searchVolume === null
      ) {
      ...
      avgDemand =
        avgDemand / parseFloat(props.analysis.searchVolumeData.length);

      let amnt = 0.03 * (avgSupply + avgDemand);
      if (
        Math.round((avgDemand / parseFloat(avgSupply + avgDemand)) * 100) ===
          100 ||
        Math.round((avgDemand / parseFloat(avgSupply + avgDemand)) * 100) === 99
      ) {
        avgDemand -= amnt;
        avgSupply += amnt;
      } else if (
        Math.round((avgDemand / parseFloat(avgSupply + avgDemand)) * 100) ===
          0 ||
        Math.round((avgDemand / parseFloat(avgSupply + avgDemand)) * 100) === 1
      ) {
        avgDemand += amnt;
        avgSupply -= amnt;
      }
  ...
  return (
      ...
      {props.loading ? (
        ...
        props.operation === "track-product" ? (
          <section class="pt-[86px] lg:pt-[77px] -mb-5 pb-10 lg:pb-[68px] bg-[#F3F4F6]">
            <h1 class="text-4xl text-center bottom-12 font-bold relative underline">
              Overview
            </h1>
            <h3 class="text-xl text-center bottom-8 lg:mb-4 mb-2 font-semibold relative ">
              Entered ID = {props.keyword && props.keyword.toUpperCase()}
            </h3>

            {Object.keys(props.analysis.productAnalysis).length === 0 ? (
              <h1 class="text-2xl text-center block pb-[60px] mx-auto font-semibold left-2 mt-[50px]">
                <svg
            ...
            <div
              class={`${
                Object.keys(props.analysis.productAnalysis).length === 0
                  ? "hidden"
                  : "lg:flex block"
              } lg:mb-1 mb-5 xl:container mx-auto xl:right-[39px] xl:px-0 px-7 xl:gap-x-0 gap-x-7  relative -top-2`}
            >
              <div class="lg:w-1/2 md:w-[80%] sm:w-[90%] w-[96%] block mx-auto mt-[30px] xl:top-0 lg:top-[20px] relative">
                <div class="flex flex-col items-center justify-center h-fit xl:max-w-[500px] max-w-[700px] left-2 mx-auto">
                  <div
                    class="w-full h-72 bg-gray-800 border-2 border-blue-700 bg-no-repeat bg-center  ring-2 ring-blue-700 ring-offset-2 ring-offset-indigo-200 bg-contain rounded-lg shadow-md"
                    style={{
                      backgroundImage: `url(${props.analysis.productAnalysis.image})`,
                    }}
                  ></div>

                  <div class=" -mt-10 overflow-hidden  rounded-lg shadow-lg sm:w-[293px] w-[260px] top-[3px] relative bg-gray-800">
                    <h3 class="py-2 pb-1 font-bold truncate px-3 tracking-wide text-center  uppercase text-white">
                      {props.analysis.productAnalysis.title}
                    </h3>
                    ...
                    <div class="flex items-center text-center justify-between px-3 py-2 pt-1.5 border-t-2 border-dotted border-blue-500  bg-gray-800">
                      <span class="font-bold text-center relative bottom-[1px] mx-auto block text-gray-200">
                        {props.analysis.productAnalysis.price
                          ? "AED " + props.analysis.productAnalysis.price
                          : props.analysis.productAnalysis.ASIN}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <a
                  onClick={() => {
                    setReviewData({
                      reviews: props.analysis.productAnalysis.reviews,
   ...
   "
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-[22px] w-[22px] mr-[8px] bottom-[1.5px] inline relative text-gray-300 "
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2"
              ...
              <div class="lg:w-1/2 md:w-[80%] sm:w-[90%] w-[96%] lg:mt-0 mt-10 block mx-auto bg-gradient-to-tr from-blue-100 rounded-sm pb-6 shadow-md to-indigo-200">
                <h1 class="font-semibold text-[20px] pt-2 pb-2.5  bg-white text-center truncate md:px-16 sm:px-10 px-4 border-b-2 border-blue-700">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-6 w-6 text-blue-800 relative inline bottom-[2.5px] mr-1.5"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2"
                ...
                <h1 class="font-normal sm:px-7 px-3 underline text-[16px] pt-2.5 pb-1.5  text-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-[17px] w-[17px] inline relative bottom-[1.4px] right-[2px]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2"
                  ...
                  Search Result Pages (SERPS) = Product List Results for Search
                  Entries
                </h1>
                ...
                <h1 class="text-center font-semibold sm:px-10 px-6 text-lg my-1 mb-1.5 relative block">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-6 relative inline w-6 mr-1 right-[1px] bottom-[1px]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2"
                  ...
                  Appeared in{" "}
                  <strong class="text-blue-700 text-[26px] mx-1">
                    {props.analysis.productAnalysis.count}
                  </strong>{" "}
                  {props.analysis.productAnalysis.count === 1 ? "" : "Total"}{" "}
                  Search Result Page
                  {props.analysis.productAnalysis.count === 1 ? "" : "s"}{" "}
                  (SERPS)
                </h1>
                ...
                <h1 class="text-center font-semibold sm:px-10 px-6 text-lg mb-3 relative block">
                  ...
                  Searches made for this Product:{" "}
                  <strong class="text-blue-700 text-[26px] mx-1">
                    {props.analysis.productAnalysis.totalSearchVolume}
                  </strong>{" "}
                </h1>
                ...
                <h1 class="font-normal sm:px-10 px-6 text-[16px] pt-1 pb-1.5 mt-1 xl:pl-16  xl:text-left text-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5 relative mr-1 inline bottom-[1px]"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
                  ...
                  Appeared in <strong>Rank #1</strong> in{" "}
                  <strong>{props.analysis.productAnalysis.pos_1}</strong> Search
                  Result Page
                  {props.analysis.productAnalysis.pos_1 === 1 ? "" : "s"}{" "}
                  (SERPS).
                </h1>
                <h1 class="font-normal text-[16px] sm:px-10 px-6 pb-1.5 xl:pl-16  xl:text-left text-center">
                  ...
                  Appeared in <strong>Ranks #2-3</strong> in{" "}
                  <strong>{props.analysis.productAnalysis.pos_2_3}</strong>{" "}
                  Search Result Page
                  {props.analysis.productAnalysis.pos_2_3 === 1 ? "" : "s"}{" "}
                  (SERPS).
                </h1>
                <h1 class="font-normal text-[16px] sm:px-10 px-6 pb-1.5 xl:pl-16  xl:text-left text-center">
                  <svg
                ...
                <button
                  class="bg-white hover:bg-gray-100 shadow-md p-2 px-5 py-2 rounded-lg border-2 border-blue-700 hover:shadow-lg mt-7  block mx-auto relative text-lg font-semibold"
                  onClick={() => {
            ...
            {props.analysis &&
            props.analysis.rankedKeywords &&
            props.analysis.rankedKeywords.length > 0 ? (
            ...
            <h1 class="text-4xl text-center bottom-12 font-bold relative underline">
              Direct Competition (Substitutes)
            </h1>
            <h3 class="text-xl text-center bottom-10 mb-7 font-semibold relative ">
              View Immediate Alternatives/Substitutes for Entered ASIN ID
            </h3>

            {props.analysis.competitorData.length == 0 ? (
              <h1 class="text-2xl text-center block pb-[90px] lg:mb-[70px] mb-[100px] mx-auto font-semibold left-2 mt-[50px]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-14 w-14 mb-6 mx-auto block text-center text-red-700"
                  fill="none"
                ...
                return (
                  <div key={i} class=" bottom-10 -top-9 relative mb-4">
                    <h3 class="text-3xl text-center font-bold relative ">
                      Substitute <strong class="text-blue-700">Product</strong>{" "}
                      <strong class="text-4xl">#{i + 1}</strong>
                    </h3>
                    <h2 class="text-xl mt-1 top-[7px] relative font-semibold underline text-center">
                      ASIN ID: {elem.ASIN}
                    </h2>
                      ...
                      <div class="lg:w-1/2 md:w-[80%] sm:w-[90%] w-[96%] block mx-auto mt-[30px] xl:top-0 lg:top-[20px] relative">
                        <div class="flex flex-col items-center justify-center h-fit xl:max-w-[500px] max-w-[700px] left-2 mx-auto">
                          ...
                          <div class=" -mt-10 overflow-hidden  rounded-lg shadow-lg sm:w-[293px] w-[260px] top-[3px] relative bg-gray-800">
                            ...
                            <div class="flex items-center text-center justify-between px-3 py-2 pt-1.5 border-t-2 border-dotted border-blue-500  bg-gray-800">
                              <span class="font-bold text-center relative bottom-[1px] mx-auto block text-gray-200">
                                {elem.price ? "AED " + elem.price : elem.ASIN}
                              </span>
                            </div>
                          </div>
                        </div>
   ...
   "
                      ...
                      <div class="lg:w-1/2 md:w-[80%] sm:w-[90%] w-[96%] lg:mt-0 mt-10 block mx-auto bg-gradient-to-tr from-blue-100 rounded-sm pb-6 shadow-md to-indigo-200">
                        ...
                        <h1 class="font-normal sm:px-7 px-3 underline text-[16px] pt-2.5 pb-1.5  text-center">
                          ...
                          Search Result Pages (SERPS) = Product List Results for
                          Search Entries
                        </h1>
                        ...
                        <h1 class="text-center font-semibold sm:px-10 px-6 text-lg my-1 mb-1.5 relative block">
                          ...
                          {elem.count === 1 ? "" : "Total"} Search Result Page
                          {elem.count === 1 ? "" : "s"} (SERPS)
                        </h1>
                        ...
                        <h1 class="font-normal sm:px-10 px-6 text-[16px] pt-1 pb-1.5 mt-1 xl:pl-16  xl:text-left text-center">
                          ...
                          Appeared in <strong>Rank #1</strong> in{" "}
                          <strong>{elem.pos_1}</strong> Search Result Page
                          {elem.pos_1 === 1 ? "" : "s"} (SERPS).
                        </h1>
                        <h1 class="font-normal text-[16px] sm:px-10 px-6 pb-1.5 xl:pl-16  xl:text-left text-center">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                          ...
                          Appeared in <strong>Ranks #2-3</strong> in{" "}
                          <strong>{elem.pos_2_3}</strong> Search Result Page
                          {elem.pos_2_3 === 1 ? "" : "s"} (SERPS).
                        </h1>
                        <h1 class="font-normal text-[16px] sm:px-10 px-6 pb-1.5 xl:pl-16  xl:text-left text-center">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                          ...
                          Appeared in <strong>Ranks #4-10</strong> in{" "}
                          <strong>{elem.pos_4_10}</strong> Search Result Page
                          {elem.pos_4_10 === 1 ? "" : "s"} (SERPS).
                        </h1>
                        <h1 class="font-normal text-[16px] sm:px-10 px-6 pb-1.5 xl:pl-16  xl:text-left text-center">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                          ...
                          Appeared in <strong>Ranks #11-100</strong> in{" "}
                          <strong>{elem.pos_11_100}</strong> Search Result Page
                          {elem.pos_11_100 === 1 ? "" : "s"} (SERPS).
                        </h1>
          ...
          <section class="pt-16 lg:pt-[80px] -mb-5 pb-10 lg:pb-[72px] bg-[#F3F4F6]">
            <div class="container mx-auto px-3">
              <h1 class="sm:text-4xl text-3xl px-2 mt-3 lg:mt-0 text-center bottom-12 font-bold relative underline">
                Overview -{" "}
                {props.keyword &&
                  props.keyword
                    .split(" ")
              ...
              <h3 class="text-xl text-center bottom-10 -mb-2 font-semibold relative ">
              ...
              <div class="flex flex-wrap bg-gradient-to-tr from-blue-100 to-indigo-200 sm:p-5 px-1 xl:pt-6 pt-3 xl:pb-5 pb-2 mb-16 shadow-lg mx-auto">
                {props.analysis === null || props.analysis.analysis === null ? (
                  ...
                  <div
                    class={`w-full ${
                      (props.analysis === null || props.analysis.analysis) ===
                      null
                        ? "hidden"
                        : "block"
                    } py-4   md:w-full xl:w-1/2 px-2`}
                  >
                    <div class="bg-white shadow-sm   p-2 py-3 pt-2 h-full flex rounded-lg overflow-hidden mb-1">
                      <div class="w-[200px] md:right-0 right-3.5 xl:block lg:hidden sm:block hidden top-1.5 relative ">
                        <GaugeChart
                          id="gauge-chart2"
                          nrOfLevels={5}
                          percent={
                            props.analysis && props.analysis.analysis
                      ...
                      <div class="xl:ml-2.5 xl:mr-5 mx-auto xl:top-[5px] top-[4px] xl:mb-0 mb-6 mt-1 relative xl:text-left lg:text-center sm:text-left text-center font-semibold md:right-0 sm:right-3.5">
                        {" "}
                        <h1 class=" relative inline underline ">
                          <FcRatings class="mr-[6px] inline text-2xl bottom-[1px] relative" />
                        ...
                        /5
                        <br />
                        <h1 class="mt-4 top-[9px] relative inline xl:text-left lg:text-center sm:text-left text-center underline ">
                          <SiMarketo class="mr-[6px] inline text-2xl bottom-[1px] relative" />
                          Evaluation:
                        </h1>{" "}
                        <span
                          class={`${
                          ...
                          }   relative inline font-bold  text-blue-700`}
                        >
                          {props.analysis.analysis.avgCompetitiveRating >= 4.5
                            ? "Very Strong"
                            : props.analysis.analysis.avgCompetitiveRating > 3.5
                            ? "Strong"
                            : props.analysis.analysis.avgCompetitiveRating > 3
                            ? "Moderate"
                            : props.analysis.analysis.avgCompetitiveRating > 2
                            ? "Poor"
                            : "Very Poor"}
                        </span>
                        <span class="relative top-[9px]">
                          {" "}
                          {props.analysis.analysis.avgCompetitiveRating > 4.5 ||
                          props.analysis.analysis.avgCompetitiveRating < 2
                            ? "C"
                ...
                >
                  <div class="bg-white flex shadow-sm xl:pb-2 lg:pb-[53px] sm:pb-9 pb-12 xl:mx-0 mx-auto h-full xl:text-left lg:text-center sm:text-left text-center rounded-lg overflow-hidden mb-1">
                    ...
                    <div class="xl:ml-[104px] xl:mr-7 md:left-0 sm:left-3 mx-auto md:top-[22px] top-[22px] relative font-semibold">
                      {" "}
                      <h1 class=" relative inline underline text-xl">
                        <FcMoneyTransfer class="mr-[8px] inline text-2xl bottom-[0px] relative sm:uppercase" />
                        Average Pricing Range:
                      </h1>{" "}
                      <br />
                      <span
                        class={` relative text-center sm:text-2xl text-xl top-[8px] left-5 mx-auto inline font-bold mr-2.5 text-blue-700`}
                      >
                        AED{" "}
                        {props.analysis &&
                          props.analysis.analysis &&
                          props.analysis.analysis.averagePricingRange.low}{" "}
                        -{" "}
                        {props.analysis &&
                          props.analysis.analysis &&
                          props.analysis.analysis.averagePricingRange.high}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <h1 class="xl:text-4xl text-3xl px-2 text-center bottom-6 mt-9 font-bold relative underline">
              High-Performing Keywords
            </h1>
            <h3 class="text-xl text-center bottom-4 mb-6 font-semibold relative ">
            ...
            (props.analysis &&
              ...
              <div class="container mx-auto -mt-1">
                <div class="flex flex-wrap bg-gradient-to-tr from-blue-100 to-indigo-200 p-5 pt-6 pb-5 mb-16 shadow-lg mx-auto">
                  ...
                  <div
                    class={`w-full py-4 ${
                      props.analysis.analysis === null ? "hidden" : "block"
                    }  xl:px-20 lg:px-0  px-4`}
                  >
                    <div class="bg-white sm:flex block mx-auto shadow-sm h-full p-4 px-10 pt-6 rounded-lg overflow-hidden mb-1">
                      <div
                        class={`sm:flex block mx-auto sm:mb-1 mb-3 sm:mt-0 mt-1 ${
                          keyWordsNum === 1 || keyWordsNum === 2
                            ? "sm:ml-2 sm:flex sm:mx-0 mx-auto block"
                            : ""
                        } items-center text-center sm:hidden sm:bottom-[3px] bottom-[-4px] relative rounded-lg`}
                      >
                        <a
                          onClick={() => {
                            setKeyWordsNum(1);
   ...
   `}
      ...
      `}
                      ...
                      <ol
                        class={` sm:w-1/2  w-[85%]  ${
                          keyWordsNum === 1
                            ? "block sm:top-5 top-7 relative sm:right-3 sm:mx-0 mx-auto"
                            : "hidden sm:block sm:bottom-3 relative"
                        } lg:top-2 xl:top-0 lg:-mb-4 block text-center`}
                      >
                        {props.analysis &&
                          props.analysis.analysis &&
                          props.analysis.analysis.topKeyWords.words.map(
                            (word, i) => {
                              if (i < 4) {
                                return (
                                  <li
                                    key={i}
                                    class="flex text-base text-center text-body-color md:mb-8 mb-12 relative  xl:mb-4"
                                  >
                                    <span
                                      class="
         bg-blue-700
         ...
         "
                                    ...
                                    <p>
                                      <span class="font-semibold ml-2 xl:text-xl text-lg underline xl:uppercase">
                                        {word &&
                                          word
                                            .replace(".", "")
                                            .replace(",", "")}
                                      ...
                                      - Appeared in{" "}
                                      <span class="text-blue-700 text-2xl font-semibold">
                                        {
                                          props.analysis.analysis.topKeyWords
                                            .count[i]
                                        }
                                      </span>{" "}
                                      out of{" "}
                      ...
                      <ol
                        class={`relative sm:w-1/2 w-[85%] ${
                          keyWordsNum === 2
                            ? "block sm:-top-4 -top-2 sm:-left-[17px] sm:mx-0 mx-auto relative"
                            : "hidden sm:block"
                        } block text-center `}
                      >
                        {props.analysis &&
                            ...
                            (word, i) => {
                              if (i >= 4) {
                                return (
                                  <li
                                    key={i}
                                    class="flex text-base text-center text-body-color md:mb-8 mb-14 lg:top-2 xl:top-0 top-10 relative xl:mb-4"
                                  >
                                    <span
                                      class="
         bg-blue-700
                ...
                <div class="flex flex-wrap  bg-gradient-to-tr from-blue-100 to-indigo-200 p-5 pt-6 pb-5 mb-16 shadow-lg mx-auto">
                  <div class="w-full mb-4 xl:px-20 lg:px-0  lg:mt-1.5 mt-10 block mx-auto    rounded-sm pb-6 ">
                    ...
                    <h1 class="font-normal sm:px-7  bg-blue-50 px-3 underline text-[16px] pt-2.5 pb-[24px] -mb-[16px] block relative  text-center">
                      ...
                      Supply = Approximate Search Results / Variety of Products
                    </h1>
                            ...
                            (keyWord, i) => {
                              return (
                                <tr class="bg-white border-b text-sm border-t-2 border-black">
                                  <th
                                    scope="row"
                                    class={`sm:px-8 px-3 py-2 border-r-[1px] uppercase border-gray-600 font-semibold ${
                                      i === 0
                                        ? "text-red-600"
                                        : i === 1
                                        ? "text-yellow-600"
                                  ...
                                  <td
                                    class={`sm:px-8 px-3 py-2  border-r-[1px] font-semibold border-gray-600 ${
                  ...
                  <div
                    class={`w-full py-4 ${
                      props.analysis.analysis === null ? "hidden" : "block"
                    } -mb-1.5 -mt-7  xl:px-20 lg:px-0  px-4`}
                  >
   ...
   `}
      ...
      `}
         ...
         "
            ...
            <h1 class="sm:text-4xl text-3xl px-2 text-center bottom-6 mt-9 font-bold relative underline">
              Best-Selling Products
            </h1>
            <h3 class="text-xl text-center bottom-4 mb-5 font-semibold relative ">
              Insights - Highest Ranking Listings{" "}
            </h3>
            ...
            <div class="lg:container lg:w-full w-[95%] lg:mt-0 mt-2 lg:mb-0 mb-8 mx-auto">
              <div class="flex flex-wrap bg-gradient-to-tr from-blue-100 to-indigo-200 p-5 pt-6 pb-5 shadow-lg mx-auto">
                ...
                {props.analysis &&
                  props.analysis.analysis &&
                  props.analysis.analysis.currentCompetition.map(
                    (product, i) => {
                      return (
                        <div
                          key={i}
                          class={`w-full py-4 ${
                            props.analysis === null ? "hidden" : "block"
                          }  md:w-1/2 xl:w-1/3 px-4`}
                        >
          ...
          <section class="pt-[73px] lg:pt-[80px] -mb-5 pb-10 lg:pb-20 bg-[#F3F4F6]">
            <h1 class="sm:text-4xl text-3xl px-3 lg:mt-0 mt-[15px] block text-center bottom-12 font-bold relative underline">
              Overview -{" "}
              {props.keyword &&
                props.keyword
                  .split(" ")
            ...
            <h3 class="text-xl text-center bottom-8 -mb-2 font-semibold relative ">
            ...
            (props.analysis.relatedKeyWordData &&
              ...
              <>
                ...
                <p class="text-center uppercase pb-[70px] font-semibold text-indigo-700 text-md relative -bottom-4 underline">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-[18.5px] w-[18.5px] inline relative bottom-[1.4px] right-[3px]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2"
                  ...
                  Your input might be invalid
                </p>
              </>
            ) : (
              <>
                <h1 class="text-xl px-2 font-semibold text-center left-[3.5px] top-[8px] relative underline uppercase mb-[30px]">
                  <span class="no-underline">1. </span>
                  <span class="text-blue-900">Demand</span>-
                  <span class="text-indigo-700">Supply</span> Balance
                </h1>
                ...
                <div class="container mx-auto bg-white px-12 py-2  rounded-sm shadow-md  sm:w-[620px] w-[90%] sm:pt-2 pt-2 sm:pb-5 pb-5 sm:pl-14 pl-4 z-[5] mb-[46px] left-[2px] relative">
                  <div class="h-fit z-[400] mt-3  block relative">
                    <div class="w-[18px] h-[18px] bg-blue-800 inline-block  mt-2 mb-2"></div>{" "}
                    <p class="inline  mb-2 mt-1 relative bottom-3 left-1 ">
                      {" "}
                      - <strong>Demand</strong> (Search Volume) -{" "}
                      <span class="font-semibold">
                        ...
                        props.analysis.searchVolumeData[0].searchVolume === null
                          ...
                          : `${String(
                              Math.round(
                                (avgDemandState /
                                  parseFloat(avgSupplyState + avgDemandState)) *
                                  100
                              )
                            )}%`}
                      </span>
                    ...
                    <br />
                    <div class="w-[18px] h-[18px] bg-indigo-500 inline-block"></div>{" "}
                    <p class="inline left-1 bottom-1  relative ">
                      - <strong>Supply</strong> (Available Products Options) -{" "}
                      <span class="font-semibold">
                        {props.analysis &&
                        props.analysis.searchVolumeData &&
                        props.analysis.searchVolumeData.length === 1 &&
                        props.analysis.searchVolumeData[0].searchResults ===
                          null
                          ? "Error"
                          : `${String(
                              Math.round(
                              ...
                              props.analysis.searchVolumeData[0]
                                ...
                                : `Demand ${String(
                                    Math.round(
                                      (avgDemandState /
                                        parseFloat(
                                          avgSupplyState + avgDemandState
                                        )) *
                                        100
                                    )
                                  ).substring(0, 2)}%`
                            }`,
                            value: avgDemandState,
                          },
                          {
                            color: "#6600ff",
                            title: `${
                ...
                <h1 class="text-xl px-2 font-semibold text-center left-[3.5px]  relative underline -mt-2 uppercase mb-[26px]">
                  <span class="no-underline">2. </span>
                  <span class="text-blue-700">Alternative Key Words</span> -
                  Analysis
                </h1>
                <div class="container mx-auto -mt-1 lg:px-0 px-5">
                  <div class="flex flex-wrap bg-gradient-to-tr from-blue-100 to-indigo-200 p-5 pt-6 pb-5 mt-1 relative mb-16 shadow-lg mx-auto">
                    ...
                    <div class="lg:w-[48%] w-[100%] lg:mt-0 mt-6 lg:left-[3%] relative rounded-md shadow-md bg-white px-1 pt-2 overflow-hidden">
                      <h1 class="text-center text-lg -mb-[3px] underline font-semibold relative px-2 top-[7px] uppercase right-[1px]">
                      ...
                      props.analysis.relatedKeyWordData.length === 0 ? (
                        <>
                          <h1 class="text-2xl text-center font-semibold mt-[70px] lg:mb-0 mb-16">
                            ...
                            Oops.. No Valid Alternatives Found
                          </h1>
                        </>
                      ) : (
                        <>
                          <div class="relative mx-auto block text-left top-[30px] left-3">
                            <div
                              class={`w-[15px]  h-[15px] bg-blue-500 inline-block mt-2 `}
                            ></div>
                            <p class="inline text-sm  mb-2 mt-1 relative bottom-[3px] left-1 ">
                              {" "}
                              - Original Key Words:{" "}
                          ...
                          <div class="mx-auto block text-center mt-10 mb-1 top-[8px] relative   pt-1 pb-2 rounded-md shadow-md text-sm bg-gradient-to-br from-blue-100 w-fit p-3 to-indigo-100">
                            ...
                            <p class="inline top-[1px] relative">
                              <p class="inline mb-2 relative">
                                {" "}
                                Slope shows <strong>Demand:Supply</strong>{" "}
                                ratio.
                              </p>
                              <br class="mb-2 relative block" />
                              <br class="mb-2 relative block" />{" "}
                              <p class="relative block -mt-4">
                                <strong>Upwards Sloping</strong> = Supply {">"}{" "}
                                Demand
                                <br /> <strong>Downwards Sloping</strong> =
                                Supply {"<"} Demand
                              </p>
                            </p>
                          </div>
                            ...
                            <table class=" text-sm text-center block mx-auto  relative text-gray-500">
                              <thead class="text-sm mx-auto w-full text-center text-gray-700 uppercase bg-gray-200  ">
                                <tr class="w-full">
                                  <th
                                    scope="col"
                                    class="sm:px-6 px-2 w-full  py-1.5"
                                  >
                                    Metric
                                  </th>
                                  <th
                ...
                <h1 class="sm:text-4xl text-3xl text-center bottom-6 mt-[48px] font-bold relative underline px-4">
                  Key Word - Demand Analysis
                </h1>
                <h3 class="text-xl text-center bottom-4 mb-6 font-semibold relative ">
                  Gauge Market Demand
                </h3>
