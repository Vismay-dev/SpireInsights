...
<div class="overflow-x-auto container  sm:w-[100%] w-[360px]  mx-auto block text-center items-center justify-center relative  ">
    <table class=" text-sm text-center w-fit h-[600px] overflow-y-scroll mx-auto block  shadow-lg border-2  border-indigo-200 text-white">
        ...
        <tbody>
            ...
            {
                props&&props.data&&props.data.length>0&&props.data.map((keyword,i)=> {
                    return (
                        <tr class="  border-gray-200">
        <th scope="row" class="py-4 px-4 font-bold uppercase  whitespace-nowrap text-white bg-gray-900">
                   {i+1}
                </th>
                <th scope="row" class="py-4 px-4 font-bold uppercase  whitespace-nowrap text-white bg-gray-800">
                   {keyword.keyWord}
                </th>
