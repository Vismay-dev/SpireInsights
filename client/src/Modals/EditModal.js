  ...
  [myRef, () => props.close()]
    ...
    return (<div class="fixed z-[100] inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div data-aos={"fade-up"} ref = {myRef} data-aos-once='true' class="pr-6 inline-block align-bottom top-10 bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:mt-5 sm:align-middle md:w-10/12 w-11/12">
          <div class="bg-white px-4 pt-0 pb-2 sm:p-6 sm:pb-4">
