...
const fetchResults = async (asin,domain) => {
    ...
    try{
        ...
        data.price = parseFloat($('div.a-section.a-spacing-none.aok-align-center > span > span.a-offscreen').text().split('AED')[1])
            ...
            data.review1 = $('#cm-cr-dp-review-list > div:nth-child(1) > div div.a-expander-content.reviewText.review-text-content.a-expander-partial-collapse-content span').text()
            data.review2 = $('#cm-cr-dp-review-list > div:nth-child(2) > div div.a-expander-content.reviewText.review-text-content.a-expander-partial-collapse-content span').text()
